...
C = DataConstraint("C_turbine3",
                   ...
                   DataBinaryOperation("-",
                                       DataBinaryOperation("-",
                                                           ...
                                                           DataBinaryOperation("/", DataBinaryOperation("*", DataBinaryOperation("*", DataBinaryOperation("/",c1,c4), DataBinaryOperation("+", c1, DataBinaryOperation("*", c2, x1))), DataBinaryOperation("*", DataBinaryOperation("*", DataBinaryOperation("*", x2, x2), x3), x3)), DataBinaryOperation("-", c1, x1))),
